...
function DropdownFilter(props: Props) {
    ...
    useEffect(()=>{
        if(visible)
        filterContainer.current.classList.add('transitFilter')
        else
        filterContainer.current.classList.remove('transitFilter')
    },[visible])

    return (
        <div ref={filterContainer} style={{transitionDuration:"0.4s"}} className={`filter-container bg-white absolute top-8 p-3 w-[300px] shadow-md rounded-lg border-[1px] border-gray-200`}>
            <div className='mb-[10px]'>
                ...
                <CDropdown>
                          ...
                          <div className='w-[265px] border-gray-300 border-[2px] flex items-center py-1 px-2 rounded-lg'>
                                <input className='drop-filter-component text-[13px] bg-transparent' value={user.organization} disabled></input>
                          ...
                          <CDropdownMenu>
                            {
                            ['marry celetia','douglas mariam','caster mills'].map((item, index)=>{
                                return (
                                    <CDropdownItem key={item}>
                                        <span className='user-toggle-item' 
                                        onClick={()=>{setUser({...user, organization: item})}}> 
                                        {item}
                                        </span>
                                        </CDropdownItem>
                                )
            ...
            <div className='mb-[10px]'>
                ...
                <div className='w-full border-gray-300 border-[2px] flex items-center py-[7px] px-2 rounded-lg'>
                    <input onChange={(event)=>{setUser({...user, username: event.target.value})}} className='drop-filter-component text-[13px]'></input>
                </div>
            </div>
            ...
            <div className='mb-[10px]'>
                ...
                <div className='w-full border-gray-300 border-[2px] flex items-center py-[7px] px-2 rounded-lg'>
                    <input type="email" onChange={(event)=>{setUser({...user, email: event.target.value})}} className='drop-filter-component text-[13px]'></input>
                </div>
            </div>
            ...
            <div className='mb-[10px]'>
                ...
                <div className='w-full border-gray-300 border-[2px] flex items-center py-[7px] px-2 rounded-lg'>
                    <input type="date"  className='drop-filter-component text-[13px]'></input>
                </div>
            </div>
            ...
            <div className='mb-[10px]'>
                ...
                <div className='w-full border-gray-300 border-[2px] flex items-center py-[7px] px-2 rounded-lg'>
                    <input type="number" onChange={(event)=>{setUser({...user, phoneNumber: event.target.value})}} className='drop-filter-component text-[13px]'></input>
                </div>
            </div>
            ...
            <div className='mb-[10px]'>
                ...
                <CDropdown>
                          <CDropdownToggle color="transparent">
                          <div className='w-[265px] border-gray-300 border-[2px] flex items-center py-1 px-2 rounded-lg'>
                                <input className='drop-filter-component text-[13px] bg-transparent' value={user.status} disabled></input>
                                <span className='w-[35px] inline-flex justify-center items-center opacity-60'>
                                    <RiArrowDownSLine size="25"/></span>
                            </div>
                            </CDropdownToggle>
                          ...
                          <CDropdownMenu>
                          {
                            ['marry celetia','douglas mariam','caster mills'].map((item, index)=>{
                                return (
                                    <CDropdownItem key={item}>
                                        <span className='user-toggle-item' 
                                        onClick={()=>{setUser({...user, status: item})}}> 
                                        {item}
                                        </span>
                                        </CDropdownItem>
                                )
