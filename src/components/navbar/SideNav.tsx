...
function SideNav(props: Props) {
  ...
  const [routes, setRoutes] = useState({
    ...
    business: [
      ...
      },
      {
        ...
        Element: <SavingFeeIcon width={iconWidth} />,
      },
      {
        name: 'Fees and Charges',
        route: '/Fees-and-Charges',
        Element: <FeesChargesIcon width={iconWidth} />,
      },
      {
        name: 'Transactions',
        route: '/Transactions',
        Element: <TransactionIcon width={iconWidth} />,
      },
      {
        name: 'Services',
        route: '/Services',
        Element: <ServicesIcon width={iconWidth} />,
      },
      {
        name: 'Service Account',
        route: '/Service-Account',
        Element: <ServiceAccount width={iconWidth} />,
      },
      {
        name: 'Settlements',
        route: '/Settlements',
        Element: <SettlementsIcon width={iconWidth} />,
      },
      {
        name: 'Reports',
        route: '/reports',
        Element: <ReportsIcon width={iconWidth} />,
      },
    ],
  })
  ...
  useEffect(() => {
    ...
    let childTranslateNav = setInterval(() => {
      ;(pallet[start] as any).style.cssText = 'opacity:0.4;left:0'
      start++
